...
/**
 * THIS PROGRAM IS PROVIDED "AS IS" WITHOUT ANY WARRANTIES (OR CONDITIONS), EXPRESS OR IMPLIED WITH
 * RESPECT TO THE PROGRAM, INCLUDING THE IMPLIED WARRANTIES (OR CONDITIONS) OF MERCHANTABILITY AND
 * FITNESS FOR A PARTICULAR PURPOSE. THE ENTIRE RISK ARISING OUT OF USE OR PERFORMANCE OF THE
 * PROGRAM AND DOCUMENTATION REMAINS WITH THE USER.
 */
import java.awt.*;
import java.util.*;
...
public class VerticalLayout implements LayoutManager {
  ...
  private int
      anchor; // TOP, BOTTOM or CENTER ...where are the components positioned in an overlarge space
